...
public class legs extends AppCompatActivity {
    ...
    public  void  img1(View V)
    {
        ...
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/seated-leg-curl"));
        startActivity(webOpen);
    }
    public  void  img2(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/sumo-deadlift"));
        startActivity(webOpen);
    }
    public  void  img3(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/stiff-legged-barbell-deadlift"));
        startActivity(webOpen);
    }
    public  void  img4(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/leg-press"));
        startActivity(webOpen);
    }
    public  void  img5(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/lying-leg-curls"));
        startActivity(webOpen);
    }
    public  void  img6(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.youtube.com/watch?v=knaoCkfCt0E"));
        startActivity(webOpen);
    }
    ...
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/content/a-hamstring-and-glute-workout-fit-for-vegas.html"));
        startActivity(webOpen);
