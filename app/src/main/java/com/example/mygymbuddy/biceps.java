...
public class biceps extends AppCompatActivity {
    ...
    public  void  img1(View V)
    {
        ...
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/barbell-curl"));
        startActivity(webOpen);
    }
    public  void  img2(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/dumbbell-alternate-bicep-curl"));
        startActivity(webOpen);
    }
    public  void  img3(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/cable-hammer-curls-rope-attachment"));
        startActivity(webOpen);
    }
    public  void  img4(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/lying-triceps-press"));
        startActivity(webOpen);
    }
    public  void  img5(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/tricep-dumbbell-kickback"));
        startActivity(webOpen);
    }
    public  void  img6(View V)
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.bodybuilding.com/exercises/detail/view/name/triceps-overhead-extension-with-rope"));
        startActivity(webOpen);
    }
    ...
    {
        Intent webOpen = new Intent(android.content.Intent.ACTION_VIEW);
        webOpen.setData(Uri.parse("https://www.popworkouts.com/get-massive-arms-rock-workout/"));
        startActivity(webOpen);
